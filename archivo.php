  ...
  <body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="img/03.jpg" alt="First slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Conocimiento Para Todos</h1>
              <p>El conocimiento es para todos, por favor compartalo</p>
              <p><a class="btn btn-lg btn-success" href="#" role="button">Contactenos</a></p>
            </div>
          </div>
        </div>
        <div class="item">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p align="justify">A los 17 años empecé a trabajar como profesor de sistemas en Sistemas Unidos (Instituto de Educación Técnica), actualmente sigo trabajando ahí pero como coordinador, y en estos años de experiencia he tenido la oportunidad de recibir muchas felicitaciones por la forma de explicar y expresarme, al punto que decidí compartir este conocimiento a tantas personas como pudiera, llegando a la conclusión de que la única forma para que esto fuera posible es con la ayuda de la Internet, ¡y si estás leyendo esto es porque la idea está funcionando!.</p>
        <br>
      ...
      <div class="col-md-4">
        <img src="img/acerca.jpg" width="50%" height="50%" class="img-thumbnail">
      </div>
